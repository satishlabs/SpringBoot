...
public class MyRestEntityExceptionHandler extends ResponseEntityExceptionHandler{
	...
	/*
	 * @ExceptionHandler({CustomerIDNotFoundException.class}) public void
	 * handleCidNotFound(HttpServletResponse response) throws IOException {
	 * response.sendError(898089); }
	 * 
	 * @ExceptionHandler({InvalidPhoneNumberException.class}) public void
	 * handlePhoneNotFound(HttpServletResponse response) throws IOException {
	 * response.sendError(HttpStatus.BAD_REQUEST.value()); }
	 * 
	 * @ExceptionHandler({CityNotFoundException.class}) public void
	 * handleCityNotFound(HttpServletResponse response) throws IOException {
